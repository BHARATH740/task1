                    ...
                    <div className='main'>
                        ...
                        <form onSubmit={sample}>
                            ...
                            <div className="form-group">
                                ...
                                <span></span>
                                <input type="file" className="form-control" name='password' id="password" onChange={props.handleChange}></input>
                            </div>
                            <div className="form-group">
                                <label htmlFor="comment">comment : </label>
                                <label type="text" className="form-control" name='comment' id="comment" onChange={props.handleChange}>
                                    <textarea
                                        input ="text"
                                        maxLength={500}
